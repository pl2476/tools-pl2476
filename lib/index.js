 ...
 * @return {Array} arr
 */var getTreeArr=function(a){if(!Array.isArray(a.data))return console.log("getTreeArr=>\u8BF7\u4F20\u5165\u6570\u7EC4"),[];a.jsonData=!1!==a.jsonData||a.jsonData;var b=a.jsonData?JSON.parse(JSON.stringify(a.data)):a.data,c=[];return b.forEach(function(d){var e=0;d.children=[],b.forEach(function(b){d[a.key]===b[a.pKey]&&d.children.push(b),b[a.key]!==d[a.pKey]&&e++}),"rootPValue"in a||e!==b.length||c.push(d)}),"rootPValue"in a&&b.forEach(function(b){b[a.pKey]===a.rootPValue&&c.push(b)}),c},utils={getTreeArr:getTreeArr},_default=utils;exports["default"]=_default,module.exports=exports.default;